...
$object = new payments_history($connect);
...
<head>
  ...
  <title>PIES - Pension Exchange Information System</title>
  <!-- plugins:css -->
                      ...
                      <div class="card">
                        ...
                        <div class="card-body">
                          <div class="text-center">
                            <button class="btn print-btn" onclick="printPaymentHistory()">Print Payment Details</button>
                          </div>
                            ...
                            <table class="table table-bordered mt-4">
                              <thead>
                                <tr>
                                  ...
                                  <th>Yearly Payemnt</th>
                                  <th>Duration</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr>
                                  <td><?php echo $object->pensioner_id; ?></td>
                                  <td>
                                  ...
                                  <td>
                                    <?php echo $object->calculateYearlyPaymenet($object->calculatePensionSavings()); ?>
                                  </td>
                                  <td>10 years after retirement</td>
                                </tr>
                                <!-- Additional payment history rows can be added here -->
                              </tbody>
                            </table>
                          </div>

                          <div class="notification">
                            Stay updated with your payments and pension information!
                          </div>
                        </div>
                      </div>
                    </div>
